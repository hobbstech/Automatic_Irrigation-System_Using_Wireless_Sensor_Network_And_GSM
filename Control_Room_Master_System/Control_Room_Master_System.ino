...
#define PH_THRESHOLD_MIN  5.7 //below add lime
#define PH_THRESHOLD_MAX  6.5 //add sulphur
...
void loop() {
  ...
  */
  ...
  if (_ph < PH_THRESHOLD_MIN) {

    tft.setTextColor(ILI9340_RED);
    tft.print("pH LOW, Add LIME");
    tft.println();
    tft.setTextColor(FOREGROUND_COLOR);

  }else if (_ph > PH_THRESHOLD_MAX) {

    tft.setTextColor(ILI9340_RED);
    tft.print("pH HIGH, Add Sulphur");
    tft.println();
    tft.setTextColor(FOREGROUND_COLOR);
